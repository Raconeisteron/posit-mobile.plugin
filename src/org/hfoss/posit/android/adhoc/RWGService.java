	...
	class NetworkStart implements Runnable {
       ...
       public void run() {	
		...
		try{
			...
			FileOutputStream fos = new FileOutputStream("/data/data/org.hfoss.posit.android/files/input");
			Log.i("ADHOCCLIENT", "1");
    	...
    	try{
    		 FileInputStream fis = new FileInputStream("/data/data/org.hfoss.posit.android/files/output");
