...
public class ListPhotoFindsActivity extends ListFindsActivity implements ViewBinder{
 ...
 //   	RWGService.newFindsNum = 0;
	...
	private void fillData(String order_by) {
		...
		mCursor = PositDbHelper.getInstance().fetchFindsByProjectId(project_id, order_by);	
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.list_sortedfinds_menu, menu);
		return true;
	}
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case R.id.sort_name_menu_item:
				fillData(PositDbHelper.FINDS_NAME);
				break;
	
		case R.id.sort_date_menu_item:
				fillData(PositDbHelper.FINDS_TIME);
				break;
